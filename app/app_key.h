...
typedef enum {
    ...
    APP_KEY_UP_K1 = BUTTON_EVENT_CODE(APP_KEY_ID_K1, BUTTON_EVENT_UP),
    ...
    APP_KEY_UP_K2 = BUTTON_EVENT_CODE(APP_KEY_ID_K2, BUTTON_EVENT_UP),
    ...
    APP_KEY_UP_K3 = BUTTON_EVENT_CODE(APP_KEY_ID_K3, BUTTON_EVENT_UP),
