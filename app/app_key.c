...
static void _app_key_dispatch_event(uint32_t event)
{
    ...
    switch ((app_key_code_t)event) {
        ...
        case APP_KEY_SHORT_UP_K1:
            msg.code = APP_KEY_SHORT_UP_K1;
            (void)msgbus_topic_publish(g_app_key.key_topic, &msg, sizeof(msg));
            xlog_count("K1 key short up\r\n");
            break;
        case APP_KEY_LONG_K1:
            ...
            break;
        case APP_KEY_LONG_UP_K1:
            msg.code = APP_KEY_LONG_UP_K1;
            (void)msgbus_topic_publish(g_app_key.key_topic, &msg, sizeof(msg));
            xlog_count("K1 key long up\r\n");
            break;
        ...
        case APP_KEY_SHORT_UP_K2:
            msg.code = APP_KEY_SHORT_UP_K2;
            (void)msgbus_topic_publish(g_app_key.key_topic, &msg, sizeof(msg));
            xlog_count("K2 key short up\r\n");
            break;
        case APP_KEY_LONG_K2:
            ...
            break;
        case APP_KEY_LONG_UP_K2:
            msg.code = APP_KEY_LONG_UP_K2;
            (void)msgbus_topic_publish(g_app_key.key_topic, &msg, sizeof(msg));
            xlog_count("K2 key long up\r\n");
            break;
        ...
        case APP_KEY_SHORT_UP_K3:
            msg.code = APP_KEY_SHORT_UP_K3;
            (void)msgbus_topic_publish(g_app_key.key_topic, &msg, sizeof(msg));
            xlog_count("K3 key short up\r\n");
            break;
        case APP_KEY_LONG_K3:
            ...
            break;
        case APP_KEY_LONG_UP_K3:
            msg.code = APP_KEY_LONG_UP_K3;
            (void)msgbus_topic_publish(g_app_key.key_topic, &msg, sizeof(msg));
            xlog_count("K3 key long up\r\n");
            break;
        case APP_KEY_NONE:
        default:
            break;
